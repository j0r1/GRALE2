...
{
	return { 
		CLFloatParamInfo("mass_scaled", 0, SPEED_C*SPEED_C*getLensDistance()*deflectionScale*deflectionScale/(4.0*CONST_G), 0),
		CLFloatParamInfo("width_scaled", 1, deflectionScale, 0)
	};
}
