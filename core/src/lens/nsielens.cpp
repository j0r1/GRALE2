...
{
	return {
		CLFloatParamInfo("ellipticity", 0, 1.0, 0.01, 0.99), // TODO 0 and 1 are not allowed, what are good bounds?
		CLFloatParamInfo("sigma_scaled", 1, velScale, 0),
		CLFloatParamInfo("core_scaled", 2, deflectionScale, 0)
	};
}
