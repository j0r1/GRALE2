...
def plotImagePlane(lensOrLensInfo, sources = [], renderer = None, feedbackObject = "default", 
                   angularUnit = 1.0, subSamples = 9, sourceRgb = (0, 1, 0), imageRgb = (1, 1, 1),
...
def plotImagePlaneGnuplot(lensOrLensInfo, fileNameBase = None, sources = [], 
                          plotCaustics = True, plotCriticalLines = True, plotSources = True, plotImages = True,
                          renderer = None, feedbackObject = "default", angularUnit = 1.0, subSamples = 9,
...
def plotDensityGnuplot(lensOrLensInfo, fileNameBase = None, numX = 75, numY = 75, renderer = None, 
                       feedbackObject = "default", angularUnit = 1.0, densityUnit = 1.0,
...
def calculateDeflectionAndDerivativesForFITS(lens, numXY, angularSize, lensCenterRARec, renderer = None, 
...
def plotAverageDensityProfile(lensOrLensInfo, thetaMax, center = [0.0, 0.0], thetaSteps = 512, phiSteps = 512, 
                              angularUnit = 1.0, densityUnit = 1.0, axes = None, renderer = None,
...
def plotIntegratedMassProfile(lensOrLensInfo, thetaMax, center = [0.0, 0.0], thetaSteps = 512, phiSteps = 512,
                              angularUnit = 1.0, massUnit = 1.0, axes = None, renderer = None, feedbackObject = "default",
                              **kwargs):
...
def plotSubdivisionGrid(cells, angularUnit = 1.0, axes = None, **kwargs):
