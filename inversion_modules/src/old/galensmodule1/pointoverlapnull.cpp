...
class LensInversionGAFactorySinglePlaneCPU_PointOverlapNull : public LensInversionGAFactorySinglePlaneCPU, public mogal::GAFactoryMultiObjective
{
public:
#define HISTORYSIZE 250
#define MAXMUT 0.1f

	LensInversionGAFactorySinglePlaneCPU_PointOverlapNull() : m_fitnessHistory(2, HISTORYSIZE, 0.1)
	{
	...
	~LensInversionGAFactorySinglePlaneCPU_PointOverlapNull()
	{
	}

	LensFitnessObject *createFitnessObject()
	{
		return new LensFitnessPointOverlapNull();
	}
...
extern "C"
{
	...
	{
		return new grale::LensInversionGAFactorySinglePlaneCPU_PointOverlapNull();
	}

	GAMODS_EXPORT grale::LensFitnessObject *CreateFitnessObject()
	{
		return new grale::LensFitnessPointOverlapNull();
	}
}
