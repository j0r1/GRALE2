...
class LensInversionGAFactorySinglePlaneCPU_ExtendedNullWeak : public LensInversionGAFactorySinglePlaneCPU, public mogal::GAFactoryMultiObjective
{
public:
#define HISTORYSIZE 150
#define MAXMUT 0.1f

	LensInversionGAFactorySinglePlaneCPU_ExtendedNullWeak() : m_fitnessHistory(3, HISTORYSIZE, 0.1) // three fitness components
	{
	...
	~LensInversionGAFactorySinglePlaneCPU_ExtendedNullWeak()
	{
	}

	LensFitnessObject *createFitnessObject()
	{
		return new LensFitnessExtendedWeak();
	}
			                    ...
			                    bool *generationInfoChanged, bool *stopAlgorithm)
	{
		...
		for (int i = 0 ; i < 3 ; i++) // three fitness components
		{
...
extern "C"
{
	...
	{
		return new grale::LensInversionGAFactorySinglePlaneCPU_ExtendedNullWeak();
	}

	GAMODS_EXPORT grale::LensFitnessObject *CreateFitnessObject()
	{
		return new grale::LensFitnessExtendedWeak();
	}
}
