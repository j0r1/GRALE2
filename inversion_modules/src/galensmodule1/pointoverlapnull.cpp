...
class GridLensInversionGAFactory_PointOverlapNull : public GridLensInversionGAFactoryBase, public mogal::GAFactoryMultiObjective
{
public:
#define HISTORYSIZE 250
#define MAXMUT 0.1f

	GridLensInversionGAFactory_PointOverlapNull() : m_fitnessHistory(2, HISTORYSIZE, 0.1)
	{
	...
	~GridLensInversionGAFactory_PointOverlapNull()
	{
	}
...
extern "C"
{
	...
	{
		return new grale::GridLensInversionGAFactory_PointOverlapNull();
	}
