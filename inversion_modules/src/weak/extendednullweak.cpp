...
class GridLensInversionGAFactory_ExtendedNullWeak : public GridLensInversionGAFactoryBase, public mogal::GAFactoryMultiObjective
{
public:
#define HISTORYSIZE 150
#define MAXMUT 0.1f

	GridLensInversionGAFactory_ExtendedNullWeak() : m_fitnessHistory(3, HISTORYSIZE, 0.1) // three fitness components
	{
	...
	~GridLensInversionGAFactory_ExtendedNullWeak()
	{
	}
...
extern "C"
{
	...
	{
		return new grale::GridLensInversionGAFactory_ExtendedNullWeak();
	}
